...
pub fn load_config(path: &str) -> Result<HashMap<String, SimulationConfig>, ConfigError> {
    ...
    moonai_defaults
        ...
        .map_err(|e| ConfigError::LuaParse(e.to_string()))?;
    moonai_defaults
        .set("energy_drain_per_step", defaults.energy_drain_per_step as f64)
        .map_err(|e| ConfigError::LuaParse(e.to_string()))?;
    moonai_defaults
    ...
    moonai_defaults
        .set(
            ...
            defaults.reproduction_energy_threshold as f64,
        )
        .map_err(|e| ConfigError::LuaParse(e.to_string()))?;
    moonai_defaults
    ...
    moonai_defaults
        ...
        .map_err(|e| ConfigError::LuaParse(e.to_string()))?;
    moonai_defaults
        .set("max_steps", defaults.max_steps as f64)
        .map_err(|e| ConfigError::LuaParse(e.to_string()))?;
    moonai_defaults
    ...
    moonai_defaults
        .set(
            "compatibility_min_normalization",
            defaults.compatibility_min_normalization as f64,
        )
        .map_err(|e| ConfigError::LuaParse(e.to_string()))?;
    moonai_defaults
    ...
    moonai_defaults
        ...
        .map_err(|e| ConfigError::LuaParse(e.to_string()))?;
    moonai_defaults
        .set("seed", defaults.seed as f64)
        .map_err(|e| ConfigError::LuaParse(e.to_string()))?;
    moonai_defaults
        .set("report_interval_steps", defaults.report_interval_steps as f64)
        .map_err(|e| ConfigError::LuaParse(e.to_string()))?;

    globals
        .set("moonai_defaults", moonai_defaults)
        .map_err(|e| ConfigError::LuaParse(e.to_string()))?;

    let content = std::fs::read_to_string(path).map_err(ConfigError::Io)?;
    let experiments_table: mlua::Table = lua
        .load(&content)
        .eval()
        .map_err(|e| ConfigError::LuaParse(e.to_string()))?;
...
fn table_to_config(table: &mlua::Table) -> Result<SimulationConfig, ConfigError> {
    ...
    if let Ok(v) = table.get::<_, f64>("energy_drain_per_step") {
        config.energy_drain_per_step = v as f32;
    }
    ...
    if let Ok(v) = table.get::<_, f64>("max_steps") {
        config.max_steps = v as i32;
    }
    ...
    if let Ok(v) = table.get::<_, f64>("report_interval_steps") {
        config.report_interval_steps = v as i32;
    }
